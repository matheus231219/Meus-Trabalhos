...
CREATE TABLE `rapaziada`.`pessoal` (
  ...
  insert into pessoal(nome, idade, cidade,sexo) values("Volionor", 19, 'Floripa','M');
insert into pessoal(nome, idade, cidade,sexo) values("Matheus", 22, '','M');
insert into pessoal(nome, idade, cidade,sexo) values("Quirino", 17, 'Blumenau','M');
insert into pessoal(nome, idade, cidade,sexo) values("Julian", 18, 'Blumenau','M');
insert into pessoal(nome, idade, cidade,sexo) values("Patrick", 23, 'sao josé','M');
insert into pessoal(nome, idade, cidade,sexo) values("Coblis", 50, 'Sao Paulo','M');
insert into pessoal(nome, idade, cidade,sexo) values("Vanuza", 17, 'Floripa','F');
insert into pessoal(nome, idade, cidade,sexo) values("Adriana", 18, 'Palhoça','F');
insert into pessoal(nome, idade, cidade,sexo) values("Julia", 19, 'Palhoça','F');
